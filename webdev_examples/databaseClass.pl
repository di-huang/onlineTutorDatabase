...
#connect db
my $dbh = DBI->connect("DBI:SQLite:/webdev/user/rdong6/examples/data.db") or bail("Failed to connect to database\n");

my $html = get("http://webdev.cs.uiowa.edu/~rdong6/examples/temp.txt") or bail("Can't get file!\n");
#drop table
